...
File.callPyHandle = function(fileName) {
    var deferred = Q.defer();
    var opts = config.buildOptions("prediction?fileName=" + fileName, "GET");
    // opts.body = JSON.stringify(projectdata);
    request(opts, function(error, response, body) {
        //console.log("createProject:" + JSON.stringify(body));
        if (!error) {
